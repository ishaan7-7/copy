...
def derive_cabin(
    ...
    for i in range(1, n):
        ...
        if engine_on and ac_available and cur_ac_load > AC_MIN_ON:
            ...
            temp_target = ambient + solar_gain * 0.7
            tau         = TEMP_TAU_SOAK_S
        ...
        if engine_on and cur_ac_load > 10.0:
