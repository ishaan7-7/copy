...
of ~4.86 days each. Cuts are designated by role:
  - Cuts 0-1 (days 0-9.7)   : historical vehicles only (parked / in_service)
  - Cuts 2-6 (days 9.7-34)  : active vehicles only (streaming replay)
...
_HISTORICAL_TARGET_IDS: frozenset[str] = frozenset({
    "sim006", "sim017", "sim022", "sim026",
    "sim034", "sim036", "sim037", "sim038", "sim040",
})
