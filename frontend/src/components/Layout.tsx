...
> = {
  ...
  monitoring: {
    label: "Monitoring",
    paths: ["/cockpit-view", "/fleet-health", "/automotive", "/dtc", "/knowledge-repo"],
    color: "#0ea5e9",
    icon: MonitorHeartRoundedIcon,
  },
  engineering: {
    label: "Engineering",
    paths: ["/datascience", "/knowledge-repo"],
    color: "#f97316",
        ...
        >
          ...
          <Box sx={{ display: "flex", gap: 1, alignItems: "center" }}>
            ...
            <Tooltip title="Knowledge Repo">
              <IconButton
                size="small"
                aria-label="Open Knowledge Repo"
                onClick={() => navigate("/knowledge-repo")}
                sx={{
                  color: isKnowledgeRepo
                    ? darkMode
                      ? "#38bdf8"
                      : "#FB4E0B"
                    : darkMode
      ...
      >
        {visited("/") && (
          <Box data-app-page-scroll="" sx={{ ...hide(isCockpit), height: "100%", minHeight: 0, overflow: "auto" }}>
            <ErrorBoundary active={isCockpit} darkMode={darkMode}>
        ...
        {visited("/fleet-health") && (
          <Box sx={hide(isFleetHealth)}>
            <ErrorBoundary active={isFleetHealth} darkMode={darkMode}>
              <FleetHealth isActive={isFleetHealth} />
            </ErrorBoundary>
          </Box>
        )}
        {visited("/automotive") && (
          <Box data-app-page-scroll="" sx={{ ...hide(isAuto), height: "100%", minHeight: 0, overflow: "auto" }}>
            <ErrorBoundary active={isAuto} darkMode={darkMode}>
        ...
        {visited("/dtc") && (
          <Box sx={hide(isDtc)}>
            <ErrorBoundary active={isDtc} darkMode={darkMode}>
        ...
        {visited("/datascience") && (
          <Box sx={hide(isDataScience)}>
            <ErrorBoundary active={isDataScience} darkMode={darkMode}>
