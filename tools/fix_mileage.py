...
URBAN_TRIP_PROB = 0.60     # probability a trip segment is classified as urban
...
URBAN_MEAN_KMH  = 35.0
URBAN_STD_KMH   = 22.0
URBAN_AR        = 0.88     # autocorrelation coefficient
URBAN_MAX_KMH   = 80.0
URBAN_STOP_PROB = 0.12     # per-row probability of entering a red-light stop
URBAN_STOP_MIN  = 3        # minimum stop duration (seconds)
URBAN_STOP_MAX  = 35       # maximum stop duration (seconds)
URBAN_EMA_ALPHA = 0.10     # EMA weight for new value (lower = slower response)
...
HWY_MIN_KMH    = 60.0
HWY_MAX_KMH    = 130.0
HWY_SLOW_PROB  = 0.012     # per-row probability of toll/junction slowdown
HWY_SLOW_MIN   = 5
HWY_SLOW_MAX   = 20
HWY_EMA_ALPHA  = 0.05
