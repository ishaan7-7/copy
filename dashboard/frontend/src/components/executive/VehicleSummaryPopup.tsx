...
export default function VehicleSummaryPopup({
  ...
  const isSummaryPending = summaryQuery.isLoading || summaryQuery.isPlaceholderData;
  ...
  const isHealthHistPending = healthHistQuery.isLoading || healthHistQuery.isPlaceholderData;
  ...
  const isAlertsPending = alertsQuery.isLoading || alertsQuery.isPlaceholderData;
                  ...
                  <Box sx={{ pt: 1, borderTop: `1px solid ${isDark ? alpha("#334155", 0.5) : alpha("#e2e8f0", 1)}`, flex: 1, minHeight: 0, display: "flex", flexDirection: "column" }}>
                    ...
                    {behaviorData ? (
                      ...
                      <Typography sx={{ fontSize: 10, color: "text.secondary", textAlign: "center", py: 1 }}>
                        {isBehaviorPending ? "Loading…" : "Driver data unavailable"}
                      </Typography>
                    )}
                  </Box>
                </Box>
